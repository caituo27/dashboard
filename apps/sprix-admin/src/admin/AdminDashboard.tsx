...
export function AdminDashboard(){
 ...
 if(!metrics)return <div className="dashboard-page"><PageHeader title="Sprix 核心经营看板" subtitle={pageSubtitle}/><Alert type="warning" showIcon message="经营数据缺失" description="当前响应未包含完整经营数据。"/></div>;
